                ...
                <div class="main pt5 bc">
                    ...
                    <div class="info f12 fl pr">
                        ...
                        <div class="addInfo_tittle">
                            <img src="images/addFindInfo_pic.gif" class="fl" />
                        </div>
                        <!--}addInfo_tittle End-->
                        <form class="mt10 ml40"  action="addFindInfo.action" method="post" onsubmit="return check(this);">
                       		<table>
                            	<tr class="tr">
                            	<td></td>
                            	...
                            	<tr>
                                    ...
                                    <td>
                                    	<input type="text" class="add_goodsName mt10 mb5" name="find_name"/>
                                        <span class="red">*</span>
                                    </td>
                                    <td rowspan="7" class="add_find_pic"></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select size="1" class="add_type mt10 mb5" name="find_type">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<input type="text" class="add_place mt10 mb5" name="find_place"/>
                                        <span class="red">*</span>
                                    </td>
                                </tr>
                           ...
                           <table>
                                <tr>
                                    ...
                                    <td>
                                        <textarea class="add_describe mt10" cols="60" rows="7" style="resize:none;" name="find_detail_info"></textarea>
                                    </td>
                                    <td align="left">
                                    	&nbsp;<span class="red">*</span>
                                    </td>
