...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	<title>失物招领平台-寻物信息详情--对应点后的信息</title>
                ...
                <div class="main pt5 bc">
                    ...
                    <div class="info fl pr" style="height: auto;">
						...
						<div class="seekInfo f12 lh200 fl" style="height: auto;">
                        	<div class="seekInfo_tittle fl"></div>
                            <div class="clear"></div>
							<p class="mt10">【物品名称】：<s:property value="Linfo.lost_name" /></p>
							<p>【物品类型】：<s:property value="Linfo.lost_name" /></p>
                            <p>【丢失地点】：<s:property value="Linfo.lost_place" /></p>
                            <p>【丢失时间】：<s:property value="Linfo.lost_time" /></p>
                            <p>【联系人】： 	<s:property value="Linfo.contact_name" /></p>
                            <p class="describe">
                            	<span class="fl">【详情描述】：</span>
                            	<span class="describeMain fl"><s:property value="Linfo.lost_detail_info" /></span>
                           </p>
                        </div>
                        <!--}seekInfo End-->
                        <!--user_photo Begin{-->
						...
						<a href="validateCodeForLookContact.php?keepThis=true&lost_id=<?php echo $value['lost_id'];?>&TB_iframe=true&height=200&width=400" title="查看信息"  class="thickbox"><img src="images/find.gif"  width="100" height="30"/></a>		
						</div>
                        ...
                        <input type="hidden" name="lost_id" value="<?php echo $value['lost_id'];?>"/>
